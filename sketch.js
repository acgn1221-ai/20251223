...
function draw() {
  ...
  let leftCharY = height - 180; // 調整Y軸位置，讓角色在地板上
  ...
  let centerY = height - 180 + characterY; // 調整Y軸位置，讓角色在地板上
  ...
  let rightCharY = height - 180; // 調整Y軸位置，讓角色在地板上
  ...
  if (quizState === 'asking') {
    ...
    drawSpeechBubble(leftCharX, leftCharY - leftCharH / 2 - 20, feedbackMessage, '#fcbf49');
